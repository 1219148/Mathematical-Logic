...
| task 4 | 是 | 1136 | 桥/按钮/钥匙/剑/怪物/最终宝箱完成 |
| task 5 | 是 | 1148 | 4 个宝箱全部打开，`world_completed=True` |

task 5 额外验证：

```text
seed=0 success=True steps=1148 reward=146.370
events: chest_opened=4, key_collected=1, agent_healed=1, door_opened=1, world_completed=1
```
